...
//     /// want to create function that prints the entire row and column of element
//     // suppose element is 4 then print its row and column
...
//             if (nums[i][j] == 4)
//             {
//                 printrow(nums[i][j], i, j, 9, nums[n][n]);
//                 printcol(nums[i][j], i, j, 9, nums[n][n]);
//             }
//         }
//     }
// }

// void printrow(int element, int i, int j, int end, int nums[n][n])
// {
...
// void printcol(int element, int i, int j, int end, int nums[n][n])
// {
...
// Function prototypes
void printrow(int i, int n, int nums[][100]);
void printcol(int j, int n, int nums[][100]);
...
int main()
{
    ...
    int nums[100][100]; // safer to use a fixed large size
